...
def eval_model(dataloaders, device, tokenizer, criterion, model, output_all_results_path = '/users/gxb18167/Datasets/Checkpoints/train_decoding/results/temp.txt' ):
...
if __name__ == '__main__':
    ...
    list_of_checkpoints = [
    "Augment_v2_25_ablation_noise_random_task1_task2_taskNRv2_finetune_DCGAN_v2_Text_skipstep1_b32_20_30_5e-05_5e-07_unique_sent",
    ]
    ...
    for value in list_of_checkpoints:
        ...
        print(f'[INFO]output_all_results_path: {output_all_results_path}')

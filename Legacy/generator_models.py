...
class Generator_DCGAN_1(nn.Module):
    def __init__(self, noise_dim):
        super(Generator_DCGAN_1, self).__init__()
...
class Generator_DCGAN_2(nn.Module):
    def __init__(self, noise_dim):
        super(Generator_DCGAN_2, self).__init__()
...
class Generator_DCGAN_Text_1(nn.Module):
    def __init__(self, noise_dim, word_embedding_dim):
        super(Generator_DCGAN_Text_1, self).__init__()
...
class Generator_DCGAN_Text_2(nn.Module):
    def __init__(self, noise_dim, word_embedding_dim):
        super(Generator_DCGAN_Text_2, self).__init__()
...
class Generator_WGAN_1(nn.Module):
    def __init__(self, noise_dim):
        super(Generator_WGAN_1, self).__init__()
...
class Generator_WGAN_2(nn.Module):
    def __init__(self, noise_dim):
        super(Generator_WGAN_2, self).__init__()
...
class Generator_WGAN_Text_1(nn.Module):
    def __init__(self, noise_dim, word_embedding_dim):
        super(Generator_WGAN_Text_1, self).__init__()
...
def get_generator_model(Model_name, z_size, word_embedding_dim):
    ...
    elif Model_name == 'WGAN_Text_1.0':
        return Generator_WGAN_Text_1(z_size, word_embedding_dim)
    elif Model_name == 'WGAN_2.0':
        return Generator_WGAN_2(z_size)
    elif Model_name == 'WGAN_1.0':
        return Generator_WGAN_1(z_size)
    elif Model_name == 'DCGAN_Text_2.0':
        return Generator_DCGAN_Text_2(z_size, word_embedding_dim)
    elif Model_name == 'DCGAN_Text_1.0':
        return Generator_DCGAN_Text_1(z_size, word_embedding_dim)
    elif Model_name == 'DCGAN_2.0':
        return Generator_DCGAN_2(z_size)
    elif Model_name == 'DCGAN_1.0':
        return Generator_DCGAN_1(z_size)

...
def get_config(case):
    if case == 'train_decoding': 
        ...
        parser.add_argument('-ge', '--generator_name', default='WGAN_v1_Text', required=True)
        parser.add_argument('-gp', '--generator_path', default='./checkpoints/generator', required=True)
        ...
        parser.add_argument('-aug', '--augmentation_factor', type= float, help='augmentation_factor', default = 20, required=True)
        parser.add_argument('-augtp', '--augmentation_type', type= str, help='augmentation_type', default = 'random', required=False)
        ...
        parser.add_argument('-checkpoint', '--checkpoint', help='specify model checkpoint' ,required=False)
